...
exports.cadasturCsvService = exports.parseCadasturCsv = exports.evaluateCadasturStatus = exports.CadasturCsvError = void 0;
class CadasturCsvError extends Error {
}
exports.CadasturCsvError = CadasturCsvError;
...
const normalizeCadasturNumber = (value) => {
...
const evaluateCadasturStatus = (status) => {
    if (!status) {
        return 'UNKNOWN';
    }
...
exports.evaluateCadasturStatus = evaluateCadasturStatus;
...
const parseCadasturCsv = (input) => {
    ...
    for (let index = 1; index < table.length; index += 1) {
        ...
        if (row.length !== headerRow.length) {
            throw new CadasturCsvError(`Linha ${index + 1} possui ${row.length} colunas, esperado ${headerRow.length}`);
        }
        const raw = {};
        const normalized = {
            cadasturNumber: null,
...
exports.parseCadasturCsv = parseCadasturCsv;
exports.cadasturCsvService = {
    parse: exports.parseCadasturCsv,
    evaluateStatus: exports.evaluateCadasturStatus,
};
//# sourceMappingURL=cadastur.js.map